  ...
  return (
    <section id="home" className="relative h-screen w-full overflow-hidden flex items-center justify-center">
      <motion.div
        ...
        style={{
          backgroundImage:[
            "linear-gradient(rgba(0,0,0,0.55), rgba(0,0,0,0.65)), url('/src/assets/images/copy_4B6C8CB9-CB05-43A5-BD46-067D8B05599F.JPEG')",
      ...
      >
        <h1 className="font-heading text-6xl md:text-8xl tracking-wider">
          <img src="/IMG_2833.PNG" alt="Logo" className="h-20 w-40 rounded-full mx-auto mb-4" />
